...
namespace StorybrewScripts
{
    public class Background : StoryboardObjectGenerator
    {
        ...
        public void Section3()
        {
            ...
            forest.Scale(553888, 0.115384625);
